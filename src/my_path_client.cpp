...
int main(int argc, char **argv) {
    ...
    pose_stamped.pose.position.y=3.0; // say desired y-coord is 3.0
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    ...
    pose_stamped.pose.orientation = quat;   
    pose_stamped.pose.position.x=6.5; // say desired x-coord is 6.5
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    
    quat = convertPlanarPhi2Quaternion(1.57);
    pose_stamped.pose.orientation = quat;  
    pose_stamped.pose.position.y = 7; // say desired y-coord is 7
    path_srv.request.nav_path.poses.push_back(pose_stamped);
     
    quat = convertPlanarPhi2Quaternion(3.14);
    pose_stamped.pose.orientation = quat;  
    pose_stamped.pose.position.x=3.0; // say desired x-coord is 3
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    quat = convertPlanarPhi2Quaternion(1.57);
    pose_stamped.pose.orientation = quat;  
    pose_stamped.pose.position.y = 11.77; // say desired y-coord is 11.77
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    quat = convertPlanarPhi2Quaternion(3.14);
    pose_stamped.pose.orientation = quat;  
    path_srv.request.nav_path.poses.push_back(pose_stamped);
    pose_stamped.pose.position.x=0.0; // say desired x-coord is 0.0
    path_srv.request.nav_path.poses.push_back(pose_stamped);
